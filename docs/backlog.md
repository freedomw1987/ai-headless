...
| **下個 Sprint 計劃** | Sprint 50 Submit Gate ✅（1 commit / 0.8 SP 完成）：Commit 1 (50-0 SourcesList v2 升級 0.8) = 0.8 SP 100% ｜ 1 新功能 (SourcesList 從附件折疊區升級為可下載) ｜ RBAC 三層守衛 + path traversal 防護 + 中文檔名 RFC 5987 編碼 ｜ +23 守護測試 (超預期 +11) ｜ 測試基線 1956 → **1979** (+23 tests, 0 regression) ｜ Sprint 51 選擇待定 (SourcesList v3 圖片 preview / CRUD List 增強 / 技術債清理) |
